...
<body>
  <div class="header">
    <div class="row">
      <div class="col-lg-6">
        <span class="logo">Nacent</span></div>
        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="college" name="college" placeholder="Enter your USN" class="form-control input-md" type="text" required>
        ...
        <div class="modal-body">
          <p>
            <div class="row">
              <div class="col-md-6">
                <h3>Adarsh D<br /><br />
                  Manoj Kumar H R<br/><br/>Yashas S
                </h3>
              </div>
