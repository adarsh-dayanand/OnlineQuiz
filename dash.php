  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?q=2">Quiz Result</a></li>
...
$query = mysqli_query($con, "SELECT * FROM history ORDER BY score DESC ") or die('Error223');
  echo  "<div class='panel title'>
<table class='table table-striped title1' >";
  echo '<tr style="color:#99cc32"><td><b>Sl. No</b></td><td><b>Name</b></td><td><b>USN</b></td><td><b>Email</b></td><td><b>Title</b></td><td><b>Score</b></td><td><b>Max Marks</b></td></tr>';
...
$sql = mysqli_query($con,"SELECT title FROM quiz WHERE quiz.eid = '$eid' " )or die('Error007');
while($row=mysqli_fetch_array($sql) )
{
$title = $row['title'];

echo '<tr><td>'.$c.'</td><td>'.$name.'</td><td>'.$usn.'</td><td>' . $email . '</td><td>'. $title . '</td><td>' . $score . '</td><td>'  . $total . '</td>';
$c++;
}
}
}
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>USN</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
